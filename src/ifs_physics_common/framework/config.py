...
class GT4PyConfig(pydantic.BaseModel):
    ...
    @classmethod
    def set_exec_info(cls, v: dict | None) -> dict:
        v = v or {}
...
class PythonConfig(pydantic.BaseModel):
    ...
    @pydantic.validator("num_threads", always=True)
    @classmethod
    ...
    @pydantic.validator("gt4py_config")
    @classmethod
    def add_dtypes(cls, v: GT4PyConfig, values: dict) -> GT4PyConfig:
...
class FortranConfig(pydantic.BaseModel):
